...
export default function RatingsChart({ data }: Props) {
  ...
  if (data.every(d => d.count === 0)) return <p className="text-sm text-gray-400 py-8 text-center">{t.crm.charts.noReviews}</p>;
  ...
  return (
    <ResponsiveContainer width="100%" height={220}>
      <BarChart data={data} margin={{ top: 20, right: 10, left: 10, bottom: 5 }}>
        ...
        <Tooltip cursor={{ fill: "transparent" }} formatter={(v: number) => [v, t.crm.charts.reviews]} />
